 ...
 * @returns {Promise<any>}
 */
declare function connect(url: any, ee: any, type: any, hb: any, pocef: any): Promise<any>;
...
export { connect as rmqconnect, publish as rmqpublish, close as rmqclose, config as rmqconfig };
